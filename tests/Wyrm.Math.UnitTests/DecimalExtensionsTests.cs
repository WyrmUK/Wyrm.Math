...
public class DecimalExtensionsTests
{
    ...
    [Theory]
    [MemberData(nameof(DecimalValues))]
    public void Log_Should_Return_Log(decimal value)
    {
        // TODO: value.Log().ShouldBe(System.Math.Log(value));
    }
    ...
    public static readonly TheoryData<decimal, decimal?> DecimalExpValues = new()
    {
        ...
        { -15M, 0.0000003059023205018257885535M },
        { -10.625M, 0.0000243008312593294630038814M },
        { -3.5M, 0.0301973834223185007423528736M },
        { -2M, 0.1353352832366126919055021141M },
        { -1M, 0.3678794411714423215955237701M },
        { 0M, 1M },
        { 1M, 2.7182818284590452353602874711M },
        { 2M, 7.3890560989306502272171558355M },
        { 3.5M, 33.115451958692313750593770052M },
        { 10.625M, 41150.855677666771781443887067M },
        { 15M, 3269017.3724721106392607542332M },
        { Decimal.MaxExpPow, 79228162514264337593543950295M },
    ...
    public static readonly TheoryData<decimal, decimal, decimal?> DecimalPowValues = new()
    {
        ...
        { -5.625M, 2.1M, null },
        { -5.625M, -2.1M, null },
        { -5.625M, 3M, -177.97851562499795548563913065M },
        { -5.625M, -3M, -0.0056186556927298313486462269M },
        { 5.625M, 2.1M, 37.606014247288706271728705551M },
        { 5.625M, -2.1M, 0.0265914912817993559001249588M },
        { 5.625M, 3M, 177.97851562499795548563913065M },
        { 5.625M, -3M, 0.0056186556927298313486462269M }
    };
