...
public class DecimalExtensionsTests
{
    ...
    public void Acos_Should_Return_Acos(decimal value, decimal expected, decimal tolerance)
    {
        value.Acos().ShouldBeWithinTolerance(expected, tolerance);
    }
    ...
    {
        value.Asin().ShouldBeWithinTolerance(expected, tolerance);
    }
    ...
    public void Atan_Should_Return_Atan(decimal value, decimal expected, decimal tolerance)
    {
        value.Atan().ShouldBeWithinTolerance(expected, tolerance);
    }
    ...
    public void Cos_Should_Return_Cos(decimal value, decimal expected, decimal tolerance)
    {
        value.Cos().ShouldBeWithinTolerance(expected, tolerance);
    }
    ...
    public void Exp_Should_Return_Exp(decimal value, decimal? expected, decimal tolerance)
    {
        if (expected.HasValue)
        {
            value.Exp().ShouldBeWithinTolerance(expected.Value, tolerance);
        }
        else
        {
    ...
    public void Log_Should_Return_Log(decimal value, decimal? expected, decimal tolerance)
    {
        if (expected.HasValue)
        {
            value.Log().ShouldBeWithinTolerance(expected.Value, tolerance);
        }
        else
        {
    ...
    public void Log2_Should_Return_Log2(decimal value, decimal expected, decimal tolerance)
    {
        value.Log2().ShouldBeWithinTolerance(expected, tolerance);
    }

    [Theory]
    [MemberData(nameof(DecimalLog10Values))]
    public void Log10_Should_Return_Log10(decimal value, decimal expected, decimal tolerance)
    {
        value.Log10().ShouldBeWithinTolerance(expected, tolerance);
    }
    ...
    public static readonly TheoryData<decimal, decimal, decimal> DecimalAcosValues = new()
    {
        { -1M, Decimal.Pi, 0.0000000000000000000000000000M },
        { -0.7071067811865475244008443621M, 2.3561944901923449288469825374527695860267821329586852821412084442308M, 0.0000000000000000000000000000M },
        { -0.5M, 2.0943951023931954923084289221863352561314462662500705473166297282052M, 0.0000000000000000000000000004M },
        { -0.0000000000000000000000000002M, 1.5707963267948966192313216918397514420985846996875529104874722961539M, 0.0000000000000000000000000000M },
        { 0M, Decimal.HalfPi, 0.0000000000000000000000000000M },
        { 0.0000000000000000000000000001M, 1.5707963267948966192313216915397514420985846996875529104874722961539M, 0.0000000000000000000000000000M },
        { 0.5M, 1.0471975511965977461542144610931676280657231331250352736583148641026M, 0.0000000000000000000000000003M },
        { 0.7071067811865475244008443621M, 0.7853981633974483096156608458267332981703872664164205388337361480769M, 0.0000000000000000000000000001M },
    ...
    public static readonly TheoryData<decimal, decimal, decimal> DecimalAsinValues = new()
    {
        { -1M, -Decimal.HalfPi, 0.0000000000000000000000000000M },
        { -0.7071067811865475244008443621M, -0.785398163397448309615660845813018143928197433271132371653736148076M, 0.0000000000000000000000000001M },
        { -0.5M, -0.523598775598298873077107230546583814032861566562517636829157432051M, 0.0000000000000000000000000003M },
        ...
        { 0.5M, 0.5235987755982988730771072305465838140328615665625176368291574320513M, 0.0000000000000000000000000003M },
        { 0.7071067811865475244008443621M, 0.7853981633974483096156608458130181439281974332711323716537361480769M, 0.0000000000000000000000000001M },
        { 1M, Decimal.HalfPi, 0.0000000000000000000000000000M }
    };
    ...
    public static readonly TheoryData<decimal, decimal, decimal> DecimalAtanValues = new()
    {
        { -281474976710656M, -Decimal.HalfPi, 0.0000000000000000000000000000M },
        { -281474976710655M, -1.5707963267948930665176428911262003119937105902815980145135168701062391237M, 0.0000000000000000000000000000M },
        { -0.0000000000000000000000000001M, -0.0000000000000000000000000001M, 0.0000000000000000000000000000M },
        { 0M, 0M, 0.0000000000000000000000000000M },
        { 0.0000000000000000000000000001M, 0.0000000000000000000000000001M, 0.0000000000000000000000000000M },
        { 0.25M, 0.2449786631268641541720824812112758109141440983811840671273759146673M, 0.0000000000000000000000000001M },
        { 0.5M, 0.4636476090008061162142562314612144020285370542861202638109330887201M, 0.0000000000000000000000000001M },
        { 0.75M, 0.6435011087932843868028092287173226380415105911153123828656061187135M, 0.0000000000000000000000000003M },
        { 0.8M, 0.6747409422235526630565209736098136150740062548407124231209217049693M, 0.0000000000000000000000000002M },
        { 0.9M, 0.7328151017865065916407920727342802519857556793582560863105069319282M, 0.0000000000000000000000000014M },
        { 0.99M, 0.7803730800666358988978715172725503470193515900115397115682087765388M, 0.0000000000000000000000000002M },
        { 1M, 0.78539816339744830961566084581987572104929234984377645524373614807695410157M, 0.0000000000000000000000000001M },
        { 1.01M, 0.7903732467283023870000543410339793688885399053113777258844139833026M, 0.0000000000000000000000000001M },
        { 1.1M, 0.8329812666744317054176935618363612385158513444371084208534231225032M, 0.0000000000000000000000000002M },
        { 11M, 1.48013643959415150573293501633128582407253180337099736227055229584587194050M, 0.0000000000000000000000000002M },
        { 281474976710655M, 1.57079632679489306651764289112620031199371059028159801451351687010623912378M, 0.0000000000000000000000000000M },
        { 281474976710656M, Decimal.HalfPi, 0.0000000000000000000000000000M }
    };
    ...
    public static readonly TheoryData<decimal, decimal, decimal> DecimalCosValues = new()
    {
        ...
        { -Decimal.TwoPi, 1M, 0.0000000000000000000000000000M },
        { -Decimal.Pi * 5M / 4M, -0.70710678118654752440084436210484903928483593768847403658833986899536623923M, 0.0000000000000000000000000003M },
        { -Decimal.Pi, -1M, 0.0000000000000000000000000000M },
        { -Decimal.Pi * 3M / 4M, -0.70710678118654752440084436210484903928483593768847403658833986899536623923M, 0.0000000000000000000000000001M },
        { -Decimal.HalfPi - 0.0000000000000000000000000002M, 0M , 0.0000000000000000000000000000M},
    ...
    public static readonly TheoryData<decimal, decimal?, decimal> DecimalExpValues = new()
    {
        { Decimal.MinExpPow - 0.000000000000000000000000001M, 0M, 0.0000000000000000000000000000M },
        { Decimal.MinExpPow, 0.0000000000000000000000000001M, 0.0000000000000000000000000000M },
        { -15M, 0.0000003059023205018257883714794977022896393708207808185591165592618M, 0.0000000000000000000000000000M },
        { -10.625M, 0.0000243008312593294629935543879743434090867282418417694603902088355M, 0.0000000000000000000000000000M },
        { -3.5M, 0.0301973834223185007397862923636198450716605322476570066713402230850M, 0.0000000000000000000000000000M },
        { -2M, 0.13533528323661269189399949497248440340763154590957588146815887265407337410M, 0.0000000000000000000000000000M },
        { -1M, 0.36787944117144232159552377016146086744581113103176783450783680169746149574M, 0.0000000000000000000000000001M },
        { -0.9M, 0.4065696597405991118834542396456259878337033761703781677462886484094M, 0.0000000000000000000000000002M },
        { -0.5M, 0.6065306597126334236037995349911804534419181354871869556828921587350M, 0.0000000000000000000000000002M },
        { -0.1M, 0.9048374180359595731642490594464366211947053609804009520562573170557M, 0.0000000000000000000000000000M },
        { 0M, 1M, 0.0000000000000000000000000000M },
        { 1M, 2.71828182845904523536028747135266249775724709369995957496696762772407663035M, 0.0000000000000000000000000003M },
        { 2M, 7.38905609893065022723042746057500781318031557055184732408712782252257379607M, 0.0000000000000000000000000000M },
        { 3.5M, 33.115451958692313750653249350388616292471728226477940988860948406599M, 0.0000000000000000000000000000M },
        { 10.625M, 41150.855677666771781813446260368361936693254746423150666744319164156M, 0.0000000000000000000000040000M },
        { 15M, 3269017.372472110639301855046091721315505738543820034206629562773242021M, 0.0000000000000000000020000000M },
        { Decimal.MaxExpPow, 79228162514264337593543950257.964178924858789321131399660616414M, 10.0000000000000000000000000000M },
        { Decimal.MaxExpPow + 0.000000000000000000000000001M, null, 0.0000000000000000000000000000M }
    };
    ...
    public static readonly TheoryData<decimal, decimal?, decimal> DecimalLogValues = new()
    {
        { -1M, null, 0.0000000000000000000000000000M },
        { 0M, null, 0.0000000000000000000000000000M },
        { 1M, 0M, 0.0000000000000000000000000000M },
        { 0.0301973834223185007397862924M, -3.499999999999999999999999998795254727220790941424210372445954615373M, 0.0000000000000000000000000002M },
        { 0.1353352832366126918939994950M, -2.000000000000000000000000000M, 0.0000000000000000000000000000M },
        { 0.3678794411714423215955237701M, -1.000000000000000000000000000M, 0.0000000000000000000000000003M },
        { 0.4065696597405991118834542398M, -0.899999999999999999999999999620301199393996025370888504575095171404M, 0.0000000000000000000000000003M },
        { 0.6065306597126334236037995352M, -0.499999999999999999999999999655714771851734697418981536545106263034M, 0.0000000000000000000000000002M },
        { 0.9048374180359595731642490594M, -0.100000000000000000000000000051320403278083600631891570991139631318M, 0.0000000000000000000000000002M },
        { 2.7182818284590452353602874711M, 0.9999999999999999999999999999070506615200831402751579902770015786267M, 0.0000000000000000000000000001M },
        { 2M, 0.69314718055994530941723212145817656807550013436025525412068000949339362196M, 0.0000000000000000000000000003M },
    ...
    public static readonly TheoryData<decimal, decimal, decimal> DecimalLog2Values = new()
    {
        { 1M, 0M, 0.0000000000000000000000000000M },
        { 0.01562M, -6.000461736294832421745487309095132270225080283947662186133579595871M, 0.0000000000000000000000000002M },
        { 0.015625M, -6M, 0.0000000000000000000000000012M },
        { 0.0301973834223185007397862924M, -5.049432643111371925759736381768542450420274452914522008248013453437M , 0.0000000000000000000000000006M},
        { 0.6065306597126334236037995352M, -0.721347520444481703679962340004247477412495270920387456255692133915M, 0.0000000000000000000000000003M },
        { 7.3890560989306502272304274606M, 2.8853900817779268147198493620086639378986093348242770335320154989698M, 0.0000000000000000000000000008M },
        { 33.115451958692313750653249350M, 5.0494326431113719257597363834896921730917721579683532900860551401053M, 0.0000000000000000000000000004M },
        { 64M, 6M, 0.000000000000000000000000006M },
        { 64.1M, 6.0022524517313786799657009921102250591065761354324646480950552878962M, 0.0000000000000000000000000007M }
    };

    public static readonly TheoryData<decimal, decimal, decimal> DecimalLog10Values = new()
    {
        { 1M, 0M, 0.0000000000000000000000000000M },
        { 0.01562M, -1.806318970458718477943231698997053596254688026471046387816383649061M, 0.0000000000000000000000000002M },
        { 0.015625M, -1.806179973983887171282433368346958160609139288772651247862564766762M, 0.0000000000000000000000000005M },
        { 0.0301973834223185007397862924M, -1.520030686661381396778951215684903563963351125136283389128671915152M, 0.0000000000000000000000000001M },
        { 0.6065306597126334236037995352M, -0.217147240951625913825564459308781366361604770708895379179516886615M, 0.0000000000000000000000000001M },
        { 7.3890560989306502272304274606M, 0.8685889638065036553022578378346790895341676057866215813358187492211M, 0.0000000000000000000000000003M },
        { 33.115451958692313750653249350M, 1.5200306866613813967789512162030212575162145159323659726517952456440M, 0.0000000000000000000000000002M },
        { 64M, 1.80617997398388717128243336834695816060913928877265124786256476676264913564M, 0.0000000000000000000000000003M },
