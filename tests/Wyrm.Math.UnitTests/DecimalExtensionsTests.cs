...
public class DecimalExtensionsTests
{
    ...
    public void Asinh_Should_Return_Asinh(decimal value, decimal expected)
    {
        value.Asinh().ShouldBeWithinTolerance(expected, (int)(value.Abs().Sqr() * 0.6M));
    }
    ...
    public void Cosh_Should_Return_Cosh(decimal value, decimal expected)
    {
        value.Cosh().ShouldBeWithinTolerance(expected, (int)(value.Abs() * 1.3M));
    }
    ...
    public void Sinh_Should_Return_Sinh(decimal value, decimal expected)
    {
        value.Sinh().ShouldBeWithinTolerance(expected, (int)(value.Abs() * 2.6M));
    }
    ...
    public void Tanh_Should_Return_Tanh(decimal value, decimal expected)
    {
        value.Tanh().ShouldBeWithinTolerance(expected, (int)(value.Abs() * 1.6M));
    }
    ...
    public static readonly TheoryData<decimal, decimal> DecimalAsinhValues = new()
    {
        { -587.24115698039854549683257708M, -7.068583470577034786540947612376362005798042834685800104364189438798M },
        { -267.74489404101651425711744969M, -6.283185307179586476925286766566265698507113661842464818216079667461M },
        { -25.367158319374159246028073687M, -3.926990816987241548078304229092165929216645817597027705752280395807M },
        { -11.548739357257748377977334315M, -3.141592653589793238462643383245996047578410292107448307711589245777M },
        { -5.2279719246778036674880247893M, -2.356194490192344928846982537455833320861150725891346780846181217126M },
        { -2.3012989023072948734630400234M, -1.570796326794896619231321691626030944146378985851369018700960844536M },
        { -0.8686709614860096098969241823M, -0.785398163397448309615660845838481661607499221560674563493509415404M },
        { -0.0000000000000000000000000002M, -0.0000000000000000000000000002M },
        { 0M, 0M },
        { 0.0000000000000000000000000001M, 0.0000000000000000000000000001M },
        { 0.8686709614860096098969241823M, 0.7853981633974483096156608458384816616074992215606745634935094154041M },
        { 2.3012989023072948734630400234M, 1.5707963267948966192313216916260309441463789858513690187009608445362M },
        { 5.2279719246778036674880247893M, 2.3561944901923449288469825374558333208611507258913467808461812171267M },
        { 11.548739357257748377977334315M, 3.1415926535897932384626433832459960475784102921074483077115892457778M },
        { 25.367158319374159246028073687M, 3.9269908169872415480783042290921659292166458175970277057522803958076M },
        { 267.74489404101651425711744969M, 6.2831853071795864769252867665662656985071136618424648182160796674619M },
        { 587.24115698039854549683257708M, 7.0685834705770347865409476123763620057980428346858001043641894387984M }
    };
    ...
    public static readonly TheoryData<decimal, decimal> DecimalCoshValues = new()
    {
        { -Decimal.Pi * 9M / 4M, 587.242008418741350654868429534775146721983404110241308883600538939239953206M },
        { -Decimal.TwoPi, 267.746761483748222245931879900991004254099610204148695412202318287976406239M },
        { -Decimal.Pi * 5M / 4M, 25.3868611923607763563107575415000786664668801176631893062449508564532618987M },
        { -Decimal.Pi, 11.5919532755215206277517520525601376957709171762054225382128830484626965582M },
        { -Decimal.Pi * 3M / 4M, 5.32275214951995852027904665812511199189267170214028974617038678112025398856M },
        { -Decimal.HalfPi - 0.0000000000000000000000000002M, 2.5091784786580567820099956437296657286734833328407602787850446913577M },
        { -Decimal.HalfPi, 2.50917847865805678200999564326940594821202435814815227404797568614898589108M },
        { -Decimal.HalfPi + 0.0000000000000000000000000001M, 2.5091784786580567820099956430392760579812948708018482717170788607244M },
        { -Decimal.Pi / 4M, 1.32460908925200584666284547700338382143912100361606210242715344904309325470M },
        { 0M, 1M },
        { Decimal.Pi / 4M, 1.32460908925200584666284547700338382143912100361606210242715344904309325470M },
        { Decimal.HalfPi - 0.0000000000000000000000000001M, 2.5091784786580567820099956430392760579812948708018482717170788607244M },
        { Decimal.HalfPi, 2.50917847865805678200999564326940594821202435814815227404797568614898589108M },
    ...
    public static readonly TheoryData<decimal, decimal> DecimalSinhValues = new()
    {
        { -Decimal.Pi * 9M / 4M, -587.24115698039854549683257708147954663621345378548514695900905731085129062M },
        { -Decimal.TwoPi, -267.74489404101651425711744968805617722370618739914622009500293674933808830M },
        { -Decimal.Pi * 5M / 4M, -25.367158319374159246028073687183107205194404872371472346672568422603536367M },
        { -Decimal.Pi, -11.548739357257748377977334315388409684495189066394789455232163361061645792M },
        { -Decimal.Pi * 3M / 4M, -5.2279719246778036674880247893201936821866122539511650999157670384668422176M },
        { -Decimal.HalfPi, -2.3012989023072948734630400234344271781781465165163826659728398030935660138M },
        { -Decimal.Pi / 4M, -0.8686709614860096098969241822753544020225166383782102324308624696139336094M },
        { -0.0000000000000000000000000002M, -0.0000000000000000000000000002M },
        { 0M, 0M },
        { 0.0000000000000000000000000001M, 0.0000000000000000000000000001M },
        { Decimal.Pi / 4M, 0.86867096148600960989692418227535440202251663837821023243086246961393360948M },
        { Decimal.HalfPi, 2.30129890230729487346304002343442717817814651651638266597283980309356601380M },
        { Decimal.Pi * 3M / 4M, 5.22797192467780366748802478932019368218661225395116509991576703846684221760M },
        { Decimal.Pi, 11.5487393572577483779773343153884096844951890663947894552321633610616457924M },
        { Decimal.Pi * 5M / 4M, 25.3671583193741592460280736871831072051944048723714723466725684226035363671M },
        { Decimal.TwoPi, 267.744894041016514257117449688056177223706187399146220095002936749338088304M },
        { Decimal.Pi * 9M / 4M, 587.241156980398545496832577081479546636213453785485146959009057310851290623M }
    };
    ...
    public static readonly TheoryData<decimal, decimal> DecimalTanhValues = new()
    {
        { -Decimal.Pi * 9M / 4M, -0.9999985501065478986855902619638291925705398128505908134364839394889041326M },
        { -Decimal.TwoPi, -0.9999930253396106106051072118323457464277193773757108412245587000557877793M },
        { -Decimal.Pi * 5M / 4M, -0.9992238948786411629778100889847001609725172689413850636888080707894606272M },
        { -Decimal.Pi, -0.9962720762207499442646905800125367118968991908045876143626124159785412989M },
        { -Decimal.Pi * 3M / 4M, -0.9821933800072387798479071251867605794763057627678017594985065734455356560M },
        { -Decimal.HalfPi, -0.9171523356672743463730929214426187753679271486010889453435741242915061714M },
        { -Decimal.Pi / 4M, -0.6557942026326724356531211426917828879854700916801954830283305685915817700M },
        { -Decimal.Pi / 5M, -0.5568933069002105824038512757448591302757499699575977727451010540084720570M },
        { 0M, 0M },
        { Decimal.Pi / 5M, 0.55689330690021058240385127574485913027574996995759777274510105400847205706M },
        { Decimal.Pi / 4M, 0.65579420263267243565312114269178288798547009168019548302833056859158177008M },
        { Decimal.HalfPi, 0.91715233566727434637309292144261877536792714860108894534357412429150617140M },
        { Decimal.Pi * 3M / 4M, 0.98219338000723877984790712518676057947630576276780175949850657344553565605M },
        { Decimal.Pi, 0.99627207622074994426469058001253671189689919080458761436261241597854129898M },
        { Decimal.Pi * 5M / 4M, 0.99922389487864116297781008898470016097251726894138506368880807078946062729M },
        { Decimal.TwoPi, 0.99999302533961061060510721183234574642771937737571084122455870005578777936M },
        { Decimal.Pi * 9M / 4M, 0.99999855010654789868559026196382919257053981285059081343648393948890413260M }
    };
